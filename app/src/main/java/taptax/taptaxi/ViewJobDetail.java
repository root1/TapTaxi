...
public class ViewJobDetail extends ActionBarActivity {
    String current_lat;
    String current_long;
    double lat = 0;
    double lon = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress = new ProgressDialog(ViewJobDetail.this);
        ...
        TextView start_from = (TextView)findViewById(R.id.start_from);
        TextView going_to = (TextView)findViewById(R.id.going_to);
        ...
        time_to_user.setText("Time: "+Constants.NOTAVAILABLE);
        user_location2.setText(current_location_user_input);
        user_location_destination.setText(destination);
        time_to_destination.setText(destination);
        distance2.setText("Distance: "+Constants.NOTAVAILABLE);
        start.setText(current_location_user_input);
        start_from.setText(address);
        going_to.setText(destination);
        ...
        distance.setText(df.format(distanceKM)+" KM");
    ...
    public void getloc(){
        ...
        try {
            GPSService mGPSService = new GPSService(ViewJobDetail.this);
            mGPSService.getLocation();


            if (mGPSService.isLocationAvailable == false) {

                Toast.makeText(ViewJobDetail.this, "Your location is not available, please try again.", Toast.LENGTH_SHORT).show();
                return;
        ...
        return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    new AlertDialog.Builder(ViewJobDetail.this)
                            .setTitle(status)
                            .setCancelable(false)
                            .setMessage(message)
